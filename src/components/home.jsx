...
function Home() {
  ...
  🛒 Cart ({totalItems})
      ...
      {data.sections.map((section) => (
        <div key={section.sectionId} className="hm-section">
          <div className="hm-section-header">
             <h2 className="hm-section-title">{section.sectionName}</h2>
          </div>
            ...
            {section.products.map((product) => (
              ...
              >
                ...
                <div className="hm-product-info">
                  <h4 className="hm-product-name">{product.name}</h4>
                  ...
                  >
                    ...
                    <span className='hm-cart-text'>Add to Cart</span>
                  </button>
                </div>
              </div>
            ))}
